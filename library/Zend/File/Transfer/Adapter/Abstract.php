...
abstract class Zend_File_Transfer_Adapter_Abstract
{
    ...
    public function setDestination($destination, $files = null)
    {
        ...
        if (!is_writable($destination)) {
            require_once 'Zend/File/Transfer/Exception.php';
  //          echo "XXXXXX  $destination    XXXxxxx ";
//           throw new Zend_File_Transfer_Exception('The given destination is not writeable');
$raiDes = $destination . 'The given destination is not writeable' ;
           throw new Zend_File_Transfer_Exception($raiDes);
//           throw new Zend_File_Transfer_Exception($destination);
//           throw new Zend_File_Transfer_Exception($destination);
        }
