...
//if (isSet($input["gill"])) 
      //$gill = $input["gill"];
//$gill=$_POST["gill"];
    $topicList = $db->fetchPairs ("SELECT * FROM ResearchTopic where Conf_ID=1");
    ...
    $view->topic_list =  Zmax_View_Phplib::selectField ("subtopic", $topicList, $this->topic);
        $view->conf_list =  Zmax_View_Phplib::selectField ("topic", $conf_List, $this->topic);
