...
class AuthorController extends Myreview_Controller_Action_Auth
{
   ...
   function consoleAction()
  {
   ...
   // $this->view->setBlock ("UPLOAD", "DOWNLOAD", "DOWNLOAD_LINK");
	/////////////////
	$this->view->setBlock ("UPLOAD", "DOWNLOAD_DOCX", "DOWNLOAD_LINK_DOCX");
	$this->view->setBlock ("UPLOAD", "DOWNLOAD_DOC", "DOWNLOAD_LINK_DOC");
	//$this->view->setBlock ("UPLOAD", "DOWNLOAD_PDF", "DOWNLOAD_LINK_PDF");
	 //////////////////
...
$ext_array=explode(",",$requiredFile->file_extension2);
while (list(, $ext) = each($ext_array)) {
///////////////
          if (!$paper->fileExists($requiredFile,$ext)) {
			  $downloadLink="DOWNLOAD_LINK_".strToUpper($ext);
			  //echo $downloadLink;
            ...
            $this->view->assign("DOWNLOAD_LINK_".strToUpper($ext), "DOWNLOAD_".strToUpper($ext));
            $this->view->font_color = "green";
          }
}
...
$ext = $this->getRequest()->getParam('ext');
    ...
    $paperRow->download($requiredFileRow,$ext);
  }
