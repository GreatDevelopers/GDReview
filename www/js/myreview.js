...
ca_address = document.getElementById("ca_address");

	ca_phone = document.getElementById("ca_phone");

	ca_mobile = document.getElementById("ca_mobile");

	ca_fax = document.getElementById("ca_fax");
	...
	author_address = document.getElementById("author_address_" + id);

	author_phone = document.getElementById("author_phone_" + id);

	author_mobile = document.getElementById("author_mobile_" + id);

	author_fax = document.getElementById("author_fax_" + id);
	...
	if (author_first_name) {
		...
		author_address.value = ca_address.value;

		author_phone.value = ca_phone.value;

		author_mobile.value = ca_mobile.value;

		author_fax.value = ca_fax.value;
